...
export const connectedMessage='ZeroDebt is connected to your Finance account.\n\nYou can now send expenses, income and debt payments here.\n\nTry:\nbiryani 500\nsalary 120000\npaid 10000 credit card';
export const linkedStartMessage='ZeroDebt is connected and ready.\n\nSend something like:\nbiryani 500';
export const unlinkedStartMessage='Connect ZeroDebt to your Finance account first.\n\nOpen Finance → More → Telegram → Connect Telegram.';
